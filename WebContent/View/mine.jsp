...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  <a class="navbar-brand" href="Display">Display</a>
</nav>

<main role="main">
<div class="alert alert-primary" role="alert">
<pre>${newBlock.getMsg()}</pre>
</div>
<div>
<table data-toggle="table" id="table"
  ...
  <tbody>
	    <tr class="table-info">
	      <th scope="row">${newBlock.getIndex()}</th>
	      <td>${newBlock.getNote()}</td>
	      <td>${newBlock.getTimestamp()}</td>
	      <td>${newBlock.getNonce()}</td>
	      <td>${newBlock.getPrev_hash()}</td>
	      <td>${newBlock.getHash()}</td>
	    </tr>
